Shader "Unlit/UV_Zigzag_Pattern_Soft"
{
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Interpolators i) : SV_Target
            {
                ...
                float t = cos( (i.uv.x + xOffset) * TAU * 5) * 0.5 + 0.5; // still a repeating pattern but the range has been shifted when multiply by 0.5 & add 0.5.
